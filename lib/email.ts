...
<div style="text-align:center;margin:28px 0;"><a href="https://gettailr.vercel.app/tailor" style="display:inline-block;background:#dc4f33;color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;padding:13px 28px;border-radius:10px;">Tailor your first CV &rarr;</a></div>
...
<p style="font-size:12px;color:#a8a29e;margin:28px 0 0;line-height:1.5;">You are receiving this because you signed up for Tailr at gettailr.vercel.app. Reply with the word UNSUBSCRIBE and we will remove you.</p>
</div></body></html>`
}
