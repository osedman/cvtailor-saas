...
async function extractAssessment(
  cvText: string,
  role: { title: string; seniority: string; company_context: string },
  ...
  return raw as typeof raw & { calibration: ScoringBaselines & { confidence_level: 1 | 2 | 3 } }
}
