        ...
        <div className="mt-5 grid lg:grid-cols-[0.92fr_1.08fr] gap-6 items-start">
          ...
          <aside className="lg:sticky lg:top-20">
            ...
            <div className="mt-4 rounded-2xl bg-white border border-[#ece6da] p-5 sm:p-6">
              ...
              {cv ? <>
                <textarea value={cv.cv_text} onChange={(e) => setCv({ ...cv, cv_text: e.target.value })} rows={26} className="mt-4 w-full rounded-xl border border-[#ece6da] bg-[#fffdfa] p-4 font-mono text-xs leading-relaxed text-[#1e1813] resize-y" aria-label="Editable CV text" />
